...
Hi! My name is Daniel Olofsson. I am a junior at Minmuteman Vocational High School in Massachusetts studying Engineering. In my free time, I like solving Rubik's cube (18.8s), playing video games (Minecraft), playing volleyball, snowboarding, and using my Bambu 3D printer for solving problems. I also work as a waiter at Royal India Bistro most weekends.
...
I had purchased two phone cases for my Pixel 7 prior to designing my new one, but didn't really like either of them. The problem with the store bought cases was that they did not have a flat back and could not hold my driver's license. I really cared about getting this right and ended up designing and printing ten different versions of the case before I was happy. 
...
When my earbud case was in my pocket, I had to get up to put away my earbuds (which was annoying). To access my earbuds while sitting down, I created this model. I went through three versions for the container. The main challenge were designing the tight clearances between the inside walls so the earbud case would not fall out of my container.
...
I worked on a chiplet assembly to print as a model for ZERO ASIC to help customers what the chips will look like. The small box-like pieces with pegs replicate the small chips that will be used to make a full chip. The pieces had to have just the right tolerances in order to stay inside of the plates but also be easily removable.
...
At my job, the water spout was getting jammed and water would keep flowing after taking the pitcher away. I measured, design, and printed a new spout holder that would help with automatic shutoff. This was one of my first projects outside of my engineering classroom, so my clearances were a little off.
...
When I was about 8 years old, I was very interested in minecraft redstone. I followed many online tutorials and tried to design my own things as well. Additionally, I tried to adjust the redstone to make the building around it look better.
